...
# key option
rsync_command="ssh -o BatchMode=yes  -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -p $remote_port" # Batchmode to prevent it from waiting on user input
